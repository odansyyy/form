                    ...
                    <div className="lg:col-span-2">
                      <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                        <div className="md:col-span-5">
                          ...
                          <input type="text" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="isi nama anada" />
                        </div>
                        ...
                        <div className="md:col-span-2">
                          ...
                          <input type="text" name="city" id="city" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder='isi NPM anda' />
                        </div>

                        <div className="md:col-span-2">
                          <label for="city">Tingkat/Semester</label>
                          <input type="text" name="city" id="city" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder='isi semester anda' />
                        </div>
